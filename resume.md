...
<section class="suite-section">
  ...
  <article class="timeline-entry">
    <div class="timeline-entry__date">2019 - 2022</div>
    <div>
      <h3>Computer Science Teaching Assistant</h3>
      <p>Supported operating systems, architecture, security, networking, and algorithms labs. The role sharpened explanation, debugging, and instructional clarity across technical topics.</p>
    </div>
  </article>

  <article class="timeline-entry">
    <div class="timeline-entry__date">Education</div>
    <div>
      <h3>Santa Clara University and Colgate University</h3>
      <p>M.S. Computer Science at Santa Clara University, with prior B.A. Computer Science from Colgate University. Academic path complements the hands-on QA and networking background.</p>
    </div>
  </article>
</section>
...
<section class="suite-section">
  ...
  <div class="tag-grid">
    ...
    <section class="tag-cluster">
      <h3>Infrastructure and validation</h3>
      <div class="tag-list">
        <span class="tag">Ethernet</span>
        <span class="tag">IXIA</span>
        <span class="tag">tcpreplay</span>
    ...
    <section class="tag-cluster">
      <h3>Delivery and data tooling</h3>
      <div class="tag-list">
    ...
    <section class="tag-cluster">
      ...
      <div class="tag-list">
        ...
        <span class="tag">M.S. Computer Science</span>
        <span class="tag">B.A. Computer Science</span>
      </div>
    </section>
  </div>
</section>
